...
{
public:
  explicit Init_CountUntil_Goal_wait_duration(::my_robot_interfaces::action::CountUntil_Goal & msg)
  : msg_(msg)
  {}
  ::my_robot_interfaces::action::CountUntil_Goal wait_duration(::my_robot_interfaces::action::CountUntil_Goal::_wait_duration_type arg)
  {
...
public:
  ...
  {}
  Init_CountUntil_Goal_wait_duration target_number(::my_robot_interfaces::action::CountUntil_Goal::_target_number_type arg)
  {
