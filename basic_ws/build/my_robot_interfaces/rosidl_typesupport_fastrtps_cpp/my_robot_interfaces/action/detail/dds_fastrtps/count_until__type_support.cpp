...
#include "my_robot_interfaces/action/detail/count_until__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const my_robot_interfaces::action::CountUntil_Goal & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  my_robot_interfaces::action::CountUntil_Goal & ros_message)
{
  // Member: target_number
  cdr >> ros_message.target_number;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = my_robot_interfaces::action::CountUntil_Goal;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const my_robot_interfaces::action::CountUntil_Goal *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<my_robot_interfaces::action::CountUntil_Goal *>(
    untyped_ros_message);
...
{
  return &my_robot_interfaces::action::typesupport_fastrtps_cpp::_CountUntil_Goal__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, my_robot_interfaces, action, CountUntil_Goal)() {
  return &my_robot_interfaces::action::typesupport_fastrtps_cpp::_CountUntil_Goal__handle;
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_my_robot_interfaces
cdr_serialize(
  const my_robot_interfaces::action::CountUntil_Result & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  my_robot_interfaces::action::CountUntil_Result & ros_message)
{
  // Member: reached_number
  cdr >> ros_message.reached_number;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = my_robot_interfaces::action::CountUntil_Result;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const my_robot_interfaces::action::CountUntil_Result *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<my_robot_interfaces::action::CountUntil_Result *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &my_robot_interfaces::action::typesupport_fastrtps_cpp::_CountUntil_Result__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, my_robot_interfaces, action, CountUntil_Result)() {
  return &my_robot_interfaces::action::typesupport_fastrtps_cpp::_CountUntil_Result__handle;
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_my_robot_interfaces
cdr_serialize(
  const my_robot_interfaces::action::CountUntil_Feedback & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  my_robot_interfaces::action::CountUntil_Feedback & ros_message)
{
  // Member: current_number
  cdr >> ros_message.current_number;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = my_robot_interfaces::action::CountUntil_Feedback;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const my_robot_interfaces::action::CountUntil_Feedback *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<my_robot_interfaces::action::CountUntil_Feedback *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &my_robot_interfaces::action::typesupport_fastrtps_cpp::_CountUntil_Feedback__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, my_robot_interfaces, action, CountUntil_Feedback)() {
  return &my_robot_interfaces::action::typesupport_fastrtps_cpp::_CountUntil_Feedback__handle;
}
...
// functions for my_robot_interfaces::action::CountUntil_Goal already declared above
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_my_robot_interfaces
cdr_serialize(
  const my_robot_interfaces::action::CountUntil_SendGoal_Request & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: goal_id
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  my_robot_interfaces::action::CountUntil_SendGoal_Request & ros_message)
{
  // Member: goal_id
  ...
  size_t current_alignment)
{
  ...
  // Member: goal
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        my_robot_interfaces::action::typesupport_fastrtps_cpp::max_serialized_size_CountUntil_Goal(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = my_robot_interfaces::action::CountUntil_SendGoal_Request;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const my_robot_interfaces::action::CountUntil_SendGoal_Request *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<my_robot_interfaces::action::CountUntil_SendGoal_Request *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &my_robot_interfaces::action::typesupport_fastrtps_cpp::_CountUntil_SendGoal_Request__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, my_robot_interfaces, action, CountUntil_SendGoal_Request)() {
  return &my_robot_interfaces::action::typesupport_fastrtps_cpp::_CountUntil_SendGoal_Request__handle;
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_my_robot_interfaces
cdr_serialize(
  const my_robot_interfaces::action::CountUntil_SendGoal_Response & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: accepted
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  my_robot_interfaces::action::CountUntil_SendGoal_Response & ros_message)
{
  // Member: accepted
  {
    uint8_t tmp;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = my_robot_interfaces::action::CountUntil_SendGoal_Response;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const my_robot_interfaces::action::CountUntil_SendGoal_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<my_robot_interfaces::action::CountUntil_SendGoal_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &my_robot_interfaces::action::typesupport_fastrtps_cpp::_CountUntil_SendGoal_Response__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, my_robot_interfaces, action, CountUntil_SendGoal_Response)() {
  return &my_robot_interfaces::action::typesupport_fastrtps_cpp::_CountUntil_SendGoal_Response__handle;
}
...
{
  return &my_robot_interfaces::action::typesupport_fastrtps_cpp::_CountUntil_SendGoal__handle;
}
...
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, my_robot_interfaces, action, CountUntil_SendGoal)() {
  return &my_robot_interfaces::action::typesupport_fastrtps_cpp::_CountUntil_SendGoal__handle;
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_my_robot_interfaces
cdr_serialize(
  const my_robot_interfaces::action::CountUntil_GetResult_Request & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: goal_id
  unique_identifier_msgs::msg::typesupport_fastrtps_cpp::cdr_serialize(
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  my_robot_interfaces::action::CountUntil_GetResult_Request & ros_message)
{
  // Member: goal_id
  unique_identifier_msgs::msg::typesupport_fastrtps_cpp::cdr_deserialize(
    cdr, ros_message.goal_id);
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = my_robot_interfaces::action::CountUntil_GetResult_Request;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const my_robot_interfaces::action::CountUntil_GetResult_Request *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<my_robot_interfaces::action::CountUntil_GetResult_Request *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &my_robot_interfaces::action::typesupport_fastrtps_cpp::_CountUntil_GetResult_Request__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, my_robot_interfaces, action, CountUntil_GetResult_Request)() {
  return &my_robot_interfaces::action::typesupport_fastrtps_cpp::_CountUntil_GetResult_Request__handle;
}
...
// forward declaration of message dependencies and their conversion functions
// functions for my_robot_interfaces::action::CountUntil_Result already declared above
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_my_robot_interfaces
cdr_serialize(
  const my_robot_interfaces::action::CountUntil_GetResult_Response & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: status
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  my_robot_interfaces::action::CountUntil_GetResult_Response & ros_message)
{
  // Member: status
  cdr >> ros_message.status;
  ...
  size_t current_alignment)
{
  ...
  // Member: result
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        my_robot_interfaces::action::typesupport_fastrtps_cpp::max_serialized_size_CountUntil_Result(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = my_robot_interfaces::action::CountUntil_GetResult_Response;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const my_robot_interfaces::action::CountUntil_GetResult_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<my_robot_interfaces::action::CountUntil_GetResult_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &my_robot_interfaces::action::typesupport_fastrtps_cpp::_CountUntil_GetResult_Response__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, my_robot_interfaces, action, CountUntil_GetResult_Response)() {
  return &my_robot_interfaces::action::typesupport_fastrtps_cpp::_CountUntil_GetResult_Response__handle;
}
...
{
  return &my_robot_interfaces::action::typesupport_fastrtps_cpp::_CountUntil_GetResult__handle;
}
...
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, my_robot_interfaces, action, CountUntil_GetResult)() {
  return &my_robot_interfaces::action::typesupport_fastrtps_cpp::_CountUntil_GetResult__handle;
}
...
// functions for my_robot_interfaces::action::CountUntil_Feedback already declared above
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_my_robot_interfaces
cdr_serialize(
  const my_robot_interfaces::action::CountUntil_FeedbackMessage & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: goal_id
  unique_identifier_msgs::msg::typesupport_fastrtps_cpp::cdr_serialize(
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  my_robot_interfaces::action::CountUntil_FeedbackMessage & ros_message)
{
  // Member: goal_id
  unique_identifier_msgs::msg::typesupport_fastrtps_cpp::cdr_deserialize(
    cdr, ros_message.goal_id);
  ...
  size_t current_alignment)
{
  ...
  // Member: feedback
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        my_robot_interfaces::action::typesupport_fastrtps_cpp::max_serialized_size_CountUntil_Feedback(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = my_robot_interfaces::action::CountUntil_FeedbackMessage;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const my_robot_interfaces::action::CountUntil_FeedbackMessage *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<my_robot_interfaces::action::CountUntil_FeedbackMessage *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &my_robot_interfaces::action::typesupport_fastrtps_cpp::_CountUntil_FeedbackMessage__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, my_robot_interfaces, action, CountUntil_FeedbackMessage)() {
  return &my_robot_interfaces::action::typesupport_fastrtps_cpp::_CountUntil_FeedbackMessage__handle;
}
